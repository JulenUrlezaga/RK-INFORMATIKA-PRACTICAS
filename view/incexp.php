...
<body>
    <div class="container">
        ...
        <form method="POST" action="../controller/incexpcontroller.php">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="inputIncome" name="income" value="0.00" step="0.01" min=0 required>
            </div>
            <div class="mb-3">
                <label for="inputExpense" class="form-label">EXPENSE: </label>
                <input type="number" class="form-control" id="inputExpense" name="expense" value="0.00" step="0.01" min=0 required>
            </div>
